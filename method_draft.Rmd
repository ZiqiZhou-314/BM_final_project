...
Cook’s distance, quantile-quantile plot, and residuals plots were used to determine any outliers and influential points that would impact our model significantly. It was observed that observation 184 was an influential point, however, given the purpose of this analysis, we decided to keep this observation.
