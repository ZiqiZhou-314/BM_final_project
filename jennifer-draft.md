...
MULTICOLLINEARITY suspect multicolinearity of publication rate since
there is relationship between publication rate and experience; also
those who clin=0 (primarily research based) would have more published
...
![](jennifer-draft_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
\`\`\`
