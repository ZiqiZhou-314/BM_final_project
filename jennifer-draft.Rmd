...
```
 MULTICOLLINEARITY
suspect multicolinearity of publication rate since there is relationship
between publication rate and experience; also those who clin=0 (primarily research based) would have more published than those who do not?? 
