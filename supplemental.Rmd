...
**Table 1 -** General descriptive statistics about the data set.
\newpage
...
**Figure 1 -** Average salary distribution of both academic years 1994 and 1995(a) showing is right skewedness. Log Transformation (b) shows a normal distribution.
\newline
...
plot(f4)
```
**Figure 2 -** Residuals vs. Fitted (a), quantile-quantile plot(b), scale location plot(c) and Cook’s distance plot(d) all show the 184th observation is an outlier and potential influential point
...
**Table 2 -** Final model of the data set. Coefficient estimates, standard errors and p values are included.
\newline
\newline
...
**Table 3 -** Anova test of the model. The p-value for gender was 0.186. This value means that gender as the main covariate of interest is not a significant contributor to the model when adjusting for department, primary emphasis, certifcation, experience, and rank.
